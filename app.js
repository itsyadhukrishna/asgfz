...
const CATEGORIES = [
  {
    ...
    desc: "LRUs, VHF/HF radios, FMS, TCAS II, weather radar, ILS/VOR, transponders, ADIRU, and cockpit displays.",
    tags: ["LRU", "FMS", "TCAS", "ILS", "ADIRU"],
  },
  {
    icon: "🔥",
    ata: "ATA 71-80",
    name: "Engine Components",
    desc: "Fan blades, combustor liners, turbine vanes, fuel nozzles, ignition, and gearboxes for CFM56, GE90, V2500, PW4000.",
    tags: ["CFM56", "GE90", "V2500", "PW4000"],
  },
  {
    icon: "🛩️",
    ata: "ATA 57",
    name: "Airframe & Structures",
    desc: "Wing panels, fuselage skins, bulkheads, floor beams, control surfaces, fairings, and composite repair materials.",
    tags: ["Composite", "Structural", "Control Surfaces"],
  },
  {
    icon: "⚙️",
    ata: "ATA 29",
    name: "Hydraulic Systems",
    desc: "Hydraulic pumps, actuators, manifolds, accumulators, reservoirs, hoses, and fittings for all major types.",
    tags: ["Pumps", "Actuators", "Eaton", "Parker"],
  },
  {
    icon: "🛞",
    ata: "ATA 32",
    name: "Landing Gear",
    desc: "MLG/NLG assemblies, wheels, brakes, brake control valves, torque links, shock struts, and downlocks.",
    tags: ["Wheels", "Brakes", "Safran", "Messier"],
  },
  {
    icon: "🔋",
    ata: "ATA 24",
    name: "Electrical & Power",
    desc: "Generators, IDGs, APU starters, NiCad batteries, power distribution panels, circuit breakers, wiring.",
    tags: ["IDG", "APU", "Batteries", "Generators"],
  },
  {
    icon: "❄️",
    ata: "ATA 21",
    name: "Air Conditioning / Bleed",
    desc: "ACM packs, heat exchangers, flow control valves, ozone converters, pack controllers.",
    tags: ["ACM", "Pressurization", "Valves"],
  },
  {
    icon: "🛋️",
    ata: "ATA 25",
    name: "Cabin & Interiors",
    desc: "PSUs, overhead bins, economy & business seats, galley inserts, lavatories, and IFE systems.",
    tags: ["PSU", "Galley", "IFE", "Seats"],
  },
  {
    icon: "🔩",
    ata: "ATA 05",
    name: "Consumables & Hardware",
    desc: "Fasteners, seals, O-rings, gaskets, filters, lubricants, adhesives, and standard aviation hardware.",
    tags: ["Fasteners", "Seals", "Filters"],
  },
];
...
const PRODUCT_IMAGES = {
  Avionics:
    "https://images.unsplash.com/photo-1464037866556-6812c9d1c72e?w=600&q=75",
  Engine:
  ...
  "Air Conditioning":
    "https://images.unsplash.com/photo-1569605803663-e9337d901ff9?w=600&q=75",
  "Cabin Interiors":
    "https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?w=600&q=75",
};
...
const SAMPLE_PRODUCTS = [
  ...
  },
  {
    ...
    ac: "Boeing 737-800/-900",
    cond: "Overhauled",
    stock: "in",
    stockLabel: "In Stock",
    cert: "FAA 8130-3 + Full Trace",
    specs: {
      Aircraft: "B737-800/900",
      Condition: "Overhauled (Zero-Time)",
      Material: "Carbon Brake Pack",
  ...
  },
  {
    ...
    specs: {
      ...
      "Max RPM": "80,000",
      Weight: "7.8 kg",
      OEM: "Collins / Hamilton Sundstrand",
    },
  },
  {
    ...
    specs: {
      Screen: '10.6" HD LCD',
      System: "Panasonic eX3",
      Interfaces: "USB / Headphone",
      OEM: "Panasonic Avionics",
    },
  },
];
...
const INVENTORY = [
  {
    pn: "000-01C11T138",
    name: "HOSE ASSY , NON METALLIC",
    cat: "Avionics",
    ac: "Leonardo AW 109",
    cond: "NW",
    stock: "in-stock",
    img:"https://tasfzc.com/wp-content/uploads/2026/06/000-01C11T138-768x578.jpg",
  },
  {
    pn: "LS12326B00688B",
    name: "SPACER",
    ...
    cond: "NW",
    stock: "in-stock",
    img:"https://tasfzc.com/wp-content/uploads/2026/06/LS12326B00688B-768x576.png",
  ...
  },
  {
    ...
    cond: "NW",
    stock: "in-stock",
    img:"https://tasfzc.com/wp-content/uploads/2026/06/3G6320V04453-768x578.jpg",
  ...
  },
  {
    ...
    name: "TUBE ASSY",
    cat: "Avionics",
    ac: "Bombardier/Learjet",
    cond: "NW",
    stock: "in-stock",
    img:"https://tasfzc.com/wp-content/uploads/2026/06/315892B-768x582.png",
  ...
  },
  {
    ...
    name: "BEARING",
    cat: "Avionics",
    ac: "Airbus Helicopters H130/AS350 B3 Series",
    cond: "NW",
    stock: "in-stock",
    img:"https://tasfzc.com/wp-content/uploads/2026/06/704A33651165-768x578.jpeg",
  ...
  },
  {
    ...
    name: "LIGHT",
    cat: "Avionics",
    ac: "ATR 42 and ATR 72 regional airliners.",
    cond: "NW",
    stock: "in-stock",
    img:"https://tasfzc.com/wp-content/uploads/2026/06/301-2701.png",
  ...
  },
  {
    ...
    name: "Bushing",
    cat: "Avionics",
    ac: "Bell Helicopter (Bell 406/OH-58 Series)",
    cond: "NW",
    stock: "in-stock",
    img:"https://tasfzc.com/wp-content/uploads/2026/06/406-310-406-101-768x578.jpg",
  ...
  },
  {
    ...
    name: "Connector",
    cat: "Avionics",
    ac: "Beechcraft  King Air C90/E90 Series",
    cond: "NW",
    stock: "in-stock",
    img:"https://tasfzc.com/wp-content/uploads/2026/06/1-480305-0-768x578.jpg",
  ...
  },
  {
    ...
    name: "Clip Nut",
    cat: "Avionics",
    ac: "Boeing 737 /747 /757/767/777/787 Series",
    cond: "NW",
    stock: "in-stock",
    img:"https://tasfzc.com/wp-content/uploads/2026/06/BACN10YD6G-768x578.jpg",
...
function buildTicker() {
  ...
  el.innerHTML = doubled
    .map(
      (t) => `<span class="ticker-item"><span class="dot"></span>${t}</span>`,
    )
    .join("");
}
...
function buildFeaturedProducts(filter = "") {
  ...
  if (!grid) return;
  const items = filter
    ? SAMPLE_PRODUCTS.filter((p) => p.cat === filter)
    : SAMPLE_PRODUCTS;
  if (!items.length) {
    grid.innerHTML =
      '<p style="color:var(--muted);font-family:var(--font-mono);font-size:12px;letter-spacing:2px;padding:40px 0;grid-column:1/-1">NO PRODUCTS IN THIS CATEGORY YET — ENQUIRE DIRECTLY.</p>';
    return;
  }
...
function runSearch() {
  ...
  let results = INVENTORY.filter((item) => {
    const matchQ =
      ...
      item.ac.toLowerCase().includes(q);
    const matchFilter =
      !activeFilter ||
      item.ac.toLowerCase().includes(activeFilter.toLowerCase());
...
function openCategoryModal(idx) {
  ...
  openModal(
    ...
    `<div class="modal-pn">${c.ata}</div>
     ...
     <div style="display:flex;gap:8px;flex-wrap:wrap">${c.tags
       .map(
         (t) =>
  ...
  openModal(
    ...
    `<div class="modal-product-name">${item.name}</div>
     <table class="specs-table">
      ...
      <img src=${item.img} style="max-width:250px; border-radius:10px;">
    </td>
     </table>`,
  );
}
